...
import org.code.blocks.common.rpc.impl.RPCClient;
import org.code.blocks.common.rpc.impl.ServiceCenterImpl;
import org.code.blocks.common.rpc.impl.ServiceProviderImpl;
...
public class RpcTest {
    ...
    public static void main(String[] args) {
        ...
        new Thread(new Runnable() {
            public void run() {
                ServiceCenter serviceServer = new ServiceCenterImpl(8088);
                serviceServer.register(ServiceProvider.class, ServiceProviderImpl.class);
                serviceServer.start();
            }
        }).start();

        ServiceProvider service = RPCClient
            .getRemoteProxyObj(ServiceProvider.class, new InetSocketAddress("localhost", 8088));
